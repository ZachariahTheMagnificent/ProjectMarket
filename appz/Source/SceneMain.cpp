...
void SceneMain::InnitTextures()
{
	...
	globals.AddTexture(L"blue", L"Image//blue.tga");
	...
	globals.AddTexture(L"large forerunner floor plate", L"Image//large_forerunner_floor_plate.tga");
...
void SceneMain::InnitMaterials()
{
	...
	globals.AddMaterial(Material(L"blue",Component(1,1,1),Component(1,1,1),Component(1,1,1),20,globals.GetTexture(L"blue")));
	...
	globals.AddMaterial(Material(L"Metal",Component(1,1,1),Component(1,1,1),Component(1,1,1),20,globals.GetTexture(L"Large forrerunner floor plate")));
}
...
void SceneMain::InnitGeometry()
{
	...
	globals.AddMesh(MeshBuilder::GenerateOBJ(L"bluelift", L"OBJ//bluelift.obj"));
...
void SceneMain::InnitDraws()
{
	...
	//{
	//	drawOrder can = globals.GetDraw(L"can");
	//	wchar_t buffer[64];
	//	wsprintf(buffer, L"can%d", index);
	//	can.SetNameAs(buffer);
	//	can.transform.translate += Vector3(3,0,0);
	//	globals.AddDraw(can);
	//}
	//Draw Items
