...
private:
	...
	enum GEOMETRY_TYPE
	{
		...
		GEO_CHARACTER_LEG,
		GEO_CHARACTER_BODY,
		GEO_ROBOTCASHIER_ARM,
		GEO_ROBOTCASHIER_BODY,
		NUM_GEOMETRY,
	};
	enum DRAW_REFERENCE
	{
		...
		DRAW_CHARACTER_BODY,
		//Draw Robot cashier
		DRAW_ROBOTCASHIER_BODY,
		DRAW_ROBOTCASHIER_LEFT_ARM,
		DRAW_ROBOTCASHIER_RIGHT_ARM,
